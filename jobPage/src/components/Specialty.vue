  ...
  methods: {
    ...
    remove () {
      if (this.rowData == null) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          this.$http.post('http://101.200.147.50/tbSpecialty/remove?spId=' + spId)
            .then(response => {
    ...
    update () {
      if (this.rowData.spName === this.tbSpecialty.spName &&
        ...
        this.$http.post('http://101.200.147.50/tbSpecialty/update', this.tbSpecialty)
          .then(response => {
            if (response.data.code === 200) {
              this.$message({
                message: '恭喜你，修改成功',
    ...
    save () {
      this.$http.post('http://101.200.147.50/tbSpecialty/save', this.tbSpecialty)
        .then(response => {
          if (response.data.code === 200) {
            this.$message({
              message: '恭喜你，添加成功',
    ...
    listPage () {
      this.$http.get('http://101.200.147.50/tbSpecialty/listPage', {
        params: {
